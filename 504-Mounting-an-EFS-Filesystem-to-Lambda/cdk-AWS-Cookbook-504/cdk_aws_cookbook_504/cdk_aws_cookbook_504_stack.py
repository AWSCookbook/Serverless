...
class CdkAwsCookbook504Stack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        user_data.add_commands(
            ...
            'aws s3 cp s3://' + s3_Bucket.bucket_name + '/Recipe504Test.txt /mnt/efs',
            'sudo umount /mnt/efs'
        )
        ...
        access_point = aws_efs.AccessPoint(
            self,
            'AccessPoint',
